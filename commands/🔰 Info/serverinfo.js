...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
    ...
    try {
      ...
      embed.addField("**<:arrow:946300939512463392> Rules Channel:**", `${message.guild.rulesChannel ? `<#${message.guild.rulesChannelId}>`: "<:no:904319985004978198> \`No Channel\`"}`, true)
      embed.addField("**<:arrow:946300939512463392> Public Updates Channel:**", `${message.guild.publicUpdatesChannel ? `<#${message.guild.publicUpdatesChannelId}>`: "<:no:904319985004978198> \`No Channel\`"}`, true)
      embed.addField("**<:arrow:946300939512463392> AFK Channel:**", `${message.guild.afkChannel ? `<#${message.guild.afkChannelId}>`: "<:no:904319985004978198> \`No Channel\`"}`, true)

      embed.addField("**<:arrow:946300939512463392> NSFW Level:**", `\`${message.guild.nsfwLevel}\``, true)
      embed.addField("**<:arrow:946300939512463392> Verifcation Level:**", `\`${message.guild.verificationLevel}\``, true)
      embed.addField("**<:arrow:946300939512463392> Explicit Content Filter:**", `\`${message.guild.explicitContentFilter}\``, true)
      ...
      if(message.guild.banner) {
        ...
        .setTitle(`**<:arrow:946300939512463392> SERVER BANNER:**`)
        ...
        let embed2 = new Discord.MessageEmbed()
        .setTitle(`**<:arrow:946300939512463392> SERVER DISCOVERY SPLASH:**`)
